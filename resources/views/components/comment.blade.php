...
<div class="p-4 bg-gray-50 rounded-lg border border-gray-100 mb-4 transition-all hover:border-teal-100">
    <div class="flex items-center justify-between mb-3">
        {{-- Cabecera: Autor, Fecha e Indicador de Edición --}}
        <div class="flex items-center">
            ...
            <div class="ml-3">
                ...
                <p class="text-[10px] text-gray-400 mt-1 uppercase tracking-wider">
                    {{ $fecha }}
                    @if($comentario->hasBeenModified()) {{-- Usamos el método de tu modelo Comment.php --}}
                        <span class="ml-1 text-teal-500 font-medium">(editado)</span>
                    @endif
                </p>
            </div>
        </div>
